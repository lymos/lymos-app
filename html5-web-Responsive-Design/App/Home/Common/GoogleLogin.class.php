...
class GoogleLogin {
	...
	public $http_code;
	public $url;
	public $host = "accounts.google.com";
	public $timeout = 30;
	...
	public $http_info;
	public $useragent = 'google OAuth2 v0.1';
	public $debug = false;
	public static $boundary = '';
	function accessTokenURL()  { return 'https://accounts.google.com/o/oauth2/token'; }
	/**
	 * @ignore
	 */
	function authorizeURL()    { return 'https://accounts.google.com/o/oauth2/auth'; }
	...
	function __construct($client_id, $client_secret, $access_token = NULL, $refresh_token = NULL) {
        ...
        $this->scope = 'openid profile email https://www.googleapis.com/auth/drive.file';
	}
	...
	switch ($method) {
		...
		default:
			...
			if (!$multi && (is_array($parameters) || is_object($parameters)) ) {
                ...
                $headers[]='POST /o/oauth2/token HTTP/1.1';
